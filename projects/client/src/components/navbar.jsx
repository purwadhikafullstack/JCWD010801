import { Flex, Stack, Text, Box, Image, Avatar, Icon, Input, InputGroup, InputLeftElement, Popover, PopoverTrigger, PopoverContent, PopoverHeader, PopoverBody, Menu, MenuList, MenuItem, MenuButton, MenuDivider } from "@chakra-ui/react";
        ...
        {isNotDisabled && (
            ...
            bgColor={'blackAlpha.100'}>
                <Flex justifyContent={'space-between'} >
                    <Image cursor={'pointer'} onClick={() => navigate('/')} src={logo} w={'180px'} />
                </Flex>
                    <Flex gap={'3rem'} alignItems={'center'} justifyContent={'space-between'}>
                                ...
                                <PopoverBody>
                                    {branches.map((item, index) => {
                                        return (
                                            ...
                                            fontWeight={400}
                                            color={'gray.500'}
                                            _hover={{bgColor: 'blackAlpha.100', color: 'black', fontWeight: 500 }}
                                            >
                                                {item}
                                            </Text>
                                        )
                ...
                <Flex gap={'2rem'} alignItems={'center'}>
                    ...
                    <Icon as={BsCart} w='5' h='5' color={'black'} cursor={'pointer'} />
                    {/* <ButtonTemplate content={'Login'} /> */}
                    <Menu p='2'>

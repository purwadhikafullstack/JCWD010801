import { Box, Text, Modal, ModalBody, ModalContent, ModalCloseButton, ModalOverlay, ModalHeader, useDisclosure, Button, Divider } from "@chakra-ui/react";
                ...
                <ModalContent>
                    ...
                    {branches.map((item, index) => {
                        return (
                            ...
                            {(index + 1) !== branches.length && <Divider size={'100px'} colorScheme="blue"/>}
                            </>
                        );
                    })}
                    </ModalBody>

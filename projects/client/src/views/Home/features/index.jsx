...
export const Features = () => {
    return (
        <Stack w='100%' gap={{ base: 0, lg: 10 }}>
            <Flex wrap={{ base: 'wrap', lg: 'nowrap' }} justifyContent={'space-between'} alignItems={'center'}>
                <Heading fontSize={'3xl'} fontWeight={'semibold'} >
                    Why Alphamart?
                </Heading>
                <Flex h='20' alignItems={'center'} borderLeft={{ base: 'none', md: '3px solid black' }} >
                    <Text ml={{ base: 0, md: '10' }} color={'gray.500'} fontSize={{ base: 'sm', lg: 'lg' }}>
                        We ensure our customer have the best shopping experience
                    </Text>
                </Flex >
            </Flex>
            <Grid w='100%' gap={{ base: 5, lg: 0 }} h='100%' templateColumns={{ base: '1fr', sm: 'repeat(2, 1fr)', lg: 'repeat(4, 1fr)' }} templateRows={{ base: 'repeat(4, 1fr)', sm: 'repeat(2, 1fr)', lg: '1fr'}}>
                ...
                <GridItem justifySelf={'center'} colSpan={1} rowSpan={1}>
                    <FeatureCard icon={GiReceiveMoney} title={'Budget Friendly'} description={'Your favourite products made affordable just for you.'} />
                </GridItem>
            </Grid>
        </Stack>
    )

...
export const FeatureCard = ({ icon, title, description }) => {
    return (
        ...
        <Flex gap={'6'} w='100%' alignItems={'center'} display={{ base: 'flex', md: 'none' }}>
            <Flex w='20' h='20' justifyContent={'center'} alignItems={'center'} borderRadius={'3'} bgColor={'gray.100'} >
            ...
            >
                ...
                <Text fontSize={'lg'} fontWeight={'normal'} color={'gray.500'}>{description}</Text>
            </Stack>
        </Flex>
        </>
    )

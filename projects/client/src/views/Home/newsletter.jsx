    ...
    return (
        <Stack alignItems={'center'} gap={'2rem'}>
            <Stack justifyContent={'center'} alignItems={'center'} w={{ base: '300px', md: '400px', lg: '500px' }}>
                <Heading mb={'10px'} textAlign={'center'} fontSize={{ base: 'xl', md: '2xl', lg: '3xl' }} fontWeight={'semibold'}>
                    Subscribe to our newsletter to get our latest updates
                </Heading>
                <Text mb={'30px'} textAlign={'center'} fontSize={{ base: 'xs', md: 'sm', lg: 'md' }} fontWeight={'medium'} color={'gray.500'}>
                        ...
                        return (
                            <Form>
                                <Flex>
                                    ...
                                    <Button as={'submit'} bgColor={'black'} borderRadius={'md'}>

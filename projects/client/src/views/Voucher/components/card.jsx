...
export const VoucherCard = ({ name, imgURL, type, isPercentage, nominal, minPay, maxDisc, ProductId, BranchId, amount, validUntil, availableFrom, VoucherId }) => {
    ...
    return (
        ...
        <Flex gap={3} p={3} boxShadow={"md"} w={"470px"}>
            ...
            color={"white"} 
            w={"55%"}>
                <Stack px={3} py={1} w={"100%"} h={"100%"} bgColor={type === "Single item" && "blackAlpha.700"}>
                    {isPercentage ? (

							...
							<ModalBody>
								<Stack p={3} gap={5} w="100%" h="100%" justifyContent={"center"} alignItems={"center"}>
									...
									<Text textAlign={"center"} fontWeight={"light"}>
										You currently have an active cart on another branch. Are you sure you want to switch branch. Your
										previous cart will be cleared if you switch your branch location.
									</Text>

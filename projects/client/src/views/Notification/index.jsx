...
import { Flex, Stack, Heading, Tab, TabList, TabPanels, Tabs, Text } from "@chakra-ui/react";
	...
	return (
		<Stack mx={{ base: "20px", md: "50px" }} my={{ base: "30px" }} gap={5}>
			<Flex mb={3} alignItems={"center"} justifyContent={"space-between"}>
				<Heading fontWeight={"semibold"}>Notifications</Heading>

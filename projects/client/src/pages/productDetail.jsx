			...
			>
				<Box>
					<Box fontSize={{ base: "16px", sm: "18px", md: "20px" }} color="gray.600" mb="20px" textAlign={"left"}>
						<Link to="/search" style={{ textDecoration: 'underline' }}>Browse Products</Link>
						{" > "}
						<Link to={`/search/category/${product.CategoryId}`} style={{ textDecoration: 'underline' }}>{category}</Link>
						{" > "}

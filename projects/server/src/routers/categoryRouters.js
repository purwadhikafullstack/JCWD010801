...
router.post('/', verifyToken, checkAdmin, multerUpload(`./src/public/categories`, 'C-IMG').single('image'), categoryControllers.addCategory);
...
router.patch('/:id', verifyToken, checkAdmin, multerUpload(`./src/public/categories`, 'C-IMG').single('image'), categoryControllers.updateCategory);

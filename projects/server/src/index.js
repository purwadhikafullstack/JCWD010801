...
const { userRouters, adminRouters, productRouters, categoryRouters, addressRouters, cartRouters, orderRouters, productReportRounters } = require("./routers");
...
server.use('/api/product-report', productReportRounters);
